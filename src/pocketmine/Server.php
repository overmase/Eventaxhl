...
class Server
{
    ...
    public function __construct(\ClassLoader $autoloader, \ThreadedLogger $logger, $filePath, $dataPath, $pluginPath, $defaultLang = "unknown")
    {
        ...
        try {
            ...
            if (!is_dir($this->pluginPath . "Eventaxhl")) mkdir($this->pluginPath . "Eventaxhl");
            ...
            $this->logger->info("
§6┌─────────────────────────────────────────────────────────┐                  -- Конфигурации --
§6│§a  ______                   _                _      _     §6│      §3Дата: §7$date
§6│§a |  ____|                 | |              | |    | |    §6│      §3Версия: §7$version §3Кодовое название: §7$code
§6│§a | |__ __   __ ___  _ __  | |_  __ _ __  __| |__  | |    §6│      §3MCPE: §7$mcpe §3Протокол: §7$protocol
§6│§a |  __|\ \ / // _ \| '_ \ | __|/ _` |\ \/ /| '_ \ | |    §6│      §3IP: §7$ip §3Port: §7$port
§6│§a | |____\ V /|  __/| | | || |_| (_| | >  < | | | || |    §6│      §3Query IP: §7$query
§6│§a |______|\_/  \___||_| |_| \__|\__,_|/_/\_\|_| |_||_|    §6│      §3Расширение SSL: §7$ssl
§6│                                                         │      §3Аутентификация по XBOX: §7$mode
§6│          §bgithub.com/EventaxhlTeam/Eventaxhl             §6│      §3API версия: §7$api
§6│                                                         │      §3Язык: §7$lang
§6└─────────────────────────────────────────────────────────┘      §3Установка пакета: §7$package");
            ...
            if (!file_exists($this->dataPath . "Eventaxhl.yml")) {
                @file_put_contents($this->dataPath . "Eventaxhl.yml", $content);
            }
            $internelConfig = new Config($file, Config::YAML, []);
            $this->advancedConfig = new Config($this->dataPath . "Eventaxhl.yml", Config::YAML, []);
            ...
            $this->getAdvancedProperty("developer.eval", false);
